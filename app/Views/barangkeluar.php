<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                <a href="<?= base_url('home/TambahBarangKeluar') ?>">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px; color: black;">
                                ...
                                <tbody>
                                    <?php 
                                    $no = 1; 
                                    foreach ($barangkeluar as $record): ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        <td>
                                            <a href="<?= base_url('home/EditBarangKeluar/' . $record->id_bkeluar) ?>">
                                                <button class="btn btn-dark">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                            </a>
                                            <a href="<?= base_url('home/SDBarangKeluar/' . $record->id_bkeluar) ?>" onclick="return confirm('Yakin ingin menghapus barang ini?')">
